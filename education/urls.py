...
from .views import dictionary, topic_details, term_details, alphabet_details, SearchTermResultsListView

urlpatterns = [
    path('dictionary/', dictionary, name="dictionary"),
    path("search/", SearchTermResultsListView.as_view(), name="search_term"),
